$(document).ready(function () {
    ...
    var instrct = '+98';
    $('.phone-sep').val(instrct);
    $('.phone-sep').on('input', function (e) {
        ...
        } else if (vall.length == 9 && KeyID != 8) {

            let temp = [];
            temp = $(this).val();
            let temp_1 = temp[8];
            let temp_2 = temp[0] + temp[1] + temp[2] + temp[3] + temp[4] + temp[5] + temp[6]+ temp[7];
            $(this).val(temp_2 + '-' + temp_1);
        ...
        } else if (vall.length == 10 || vall.length == 9 || vall.length == 8) {
